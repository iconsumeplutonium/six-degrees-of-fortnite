//autogenerated via python script
//just copying over the file requires making a network request + splitting it and making an array, which takes too long
export const franchiseList: string[] = [
	"'Salem's Lot",
	"'Splosion Man",
	"'Til Death (Fox)",
	"'Til Death (tokidoki)",
	...
	"Anaconda",
	"Anal Paprika (Low Budget Pictures)",
	"Anarchy Reigns",
	"Anastasia (20th Century Studios)",
	"Anchorman",
	"Anchors Aweigh",
	"Andy Panda",
	"Andy Pandy",
	...
	"Blended",
	"Bless the Harts",
	"Blindside (Counterpoint Entertainment)",
	"Blizzard Arcade Collection",
	"Block Party (Nickelodeon)",
	"Blockhead",
	"Blockout",
	"Blondie",
	...
	"Butch Cassidy and the Sundance Kids (Hanna-Barbera)",
	...
	"Catcher in the Rye",
	"Catherine",
	"Cathy (Universal Press Syndicate)",
	"Catlateral Damage",
	"Cats & Dogs",
	"Cats (Eliot)",
	"Cats Don't Dance",
	...
	"CrossCode",
	"Crossing Souls",
	"Crossnoah of the Sky and Earth",
	...
	"Demon Turf",
	"Demon's Souls",
	"Demonslayer (Counterpoint Entertainment)",
	"Dengeki Bunko (Sega)",
	"Denkigai no Honya-san",
	"Dennis the Menace (DC Thomson)",
	...
	"Dishonored",
	"Dislyte",
	"Disney All Star Party",
	"Disney All-Stars Racers",
	...
	"DreamWorks Kart",
	"DreamWorks Most Wanted",
	"DreamWorks Movie Trivia DVD Game",
	...
	"Early Edition",
	"Early Man",
	"Earth Defense Force (D3 Publisher)",
	"Earth UFO Catcher",
	"Earth to Echo",
	"Earthworm Jim",
	"EastEnders",
	...
	"Fire Force",
	"Fire Pro Wrestling",
	"Fire and Ice (20th Century Studios)",
	"Fireball XL5",
	"Firebreather",
	"Firebuds",
	"Firefly (Fox)",
	...
	"Gulliver's Travels (20th Century Studios)",
	"Gumball",
	"Gumby",
	"Gummi Bears",
	"Gummibär",
	...
	"Hatchet (Anchor Bay Entertainment)",
	"Hatchetfield",
	"Hatching Pete",
	"Hatsune Miku",
	"Haunted House (Kmart)",
	...
	"Kaiketsu Zorori",
	"Kakegurui",
	"Kaku Spring Festival Gala",
	"Kakyoin Waifu Connoisseur",
	"Kamen America",
	"Kamen Rider",
	...
	"Legend of Eccentric Youth! 240 Academy",
	"Legend of Mushroom",
	...
	"Marvelous (Nintendo)",
	"Marvin (King Features Syndicate)",
	"Mary Bell Township",
	"Mary Poppins",
	...
	"Pocky & Rocky",
	"Pocoyo",
	"Pogo (Publishers-Hall Syndicate)",
	"Point Blank",
	...
	"Sengoku Asuka ZERO",
	"Sengoku BASARA",
	"Sengoku Puzzle!! Animal Great Battle",
	"Sennen Kazoku",
	"Senran Kagura",
	"Sentry Knight",
	"Septentrion",
	...
	"Spore",
	"Spot Bots",
	"Spring! Japan's No. 1 Anime Festival",
	"Sprout Diner",
	"Sprunki",
	"Spy Hunter",
	"Spy Kids",
	...
	"The A-Team",
	"The ABC Saturday Morning Sneak Preview",
	"The Adventure Pals",
	...
	"The Birds (Penguin Random House)",
	"The Biskitts",
	"The Black Cauldron",
	"The Black Parade",
	"The Black Phone",
	...
	"The Boxtrolls",
	"The Boys",
	"The Bradford McKinley Chronicles",
	"The Brak Show",
	...
	"The Jungle Kingdom (Tezuka Productions)",
	"The Kane Chronicles",
	"The Karate Kid",
	...
	"The Legend of Isis (Blue Water Comics)",
	"The Legend of Kage",
	...
	"The Secret of Kells",
	"The Secrets of Isis",
	"The Seven Deadly Sins (Kodansha)",
	"The Shadow (Street & Smith)",
	"The Shaggy Dog",
	"The Shape of Water",
	...
	"Umihara Kawase",
	"Unbeatable",
	"Unbelievable Laundry Detergent Man",
	"Unbreakable",
