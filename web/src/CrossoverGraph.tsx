...
//https://github.com/jacomyal/sigma.js/blob/main/packages/demo/src/canvas-utils.ts#L95
            ...
            <div style={{
                ...
                <SigmaContainer
                    ...
                    settings={{
                        ...
                        zoomToSizeRatioFunction: (x) => Math.cbrt(x),
                    }}
                >
                    <LoadGraph />
                </SigmaContainer>
